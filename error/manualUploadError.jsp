...
<tiles:insertDefinition name="baseLayout">
	<tiles:putAttribute name="head-title"> 
		<title><s:text name="label.manualuploaderror.title" /></title>
	</tiles:putAttribute>
		 ...
		 <tr>
		  ...
		  <td class="table-center-menu-td" width="94%">
			  <div id="list_pane">
			    <div class="box">
		     		<h1 align="left">
						<s:text name="label.manualuploaderror"></s:text>
					</h1>
				...
				<div style="margin-top: 10%; width: 934px">
						<div id="button" style="padding-top: 10px;" >
							<p>
								<span class="errorMessage"><s:text name="label.manualuploaderror.msg" /></span>
							</p>
							<br>
