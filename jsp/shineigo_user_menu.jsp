 ...
 <tr>
  ...
  <td class="table-center-menu-td" width="90%">
	...
	<s:if test="#session.scorerInfo.roleId == @com.saiten.util.WebAppConst@SCORER_ROLE_ID 
	  ...
	  <div class="box">
		<h1 align="left"><s:text name="label.ft.userMenu.note1"></s:text></h1>
		...
		<%--	<td class="right_side_height_button">
			...
			<td class="right_side_height_button">
				<s:if test="userMenuIdList.contains(@com.saiten.util.WebAppConst@PENDING_MENU_ID)">
					<a href="questionSelection.action?selectedMenuId=<s:property value="@com.saiten.util.WebAppConst@PENDING_MENU_ID"/>" id="pendingScoring" class="btn btn-primary btn-xl btn-x2">
	...
	<s:if test="#session.scorerInfo.roleId == @com.saiten.util.WebAppConst@SV_ROLE_ID 
		...
		|| #session.scorerInfo.roleId == @com.saiten.util.WebAppConst@ADMIN_ROLE_ID">
		<div class="box">
		<h1 align="left"><s:text name="label.ft.userMenu.note2"></s:text></h1>
		<table class="button_grid">
		<tr>
			<td class="right_side_height_button">
		...
		<tr>
			...
			<td class="right_side_height_button">
				<s:if test="userMenuIdList.contains(@com.saiten.util.WebAppConst@SCORE_SAMP_MENU_ID)">
					<a href="scoreSearch.action?selectedMenuId=<s:property value="@com.saiten.util.WebAppConst@SCORE_SAMP_MENU_ID"/>" id="scoreSampling" class="btn btn-primary btn-xl btn-x2">
...
<%-- 			<td class="right_side_height_button">
	...
	<s:if test="#session.scorerInfo.roleId == @com.saiten.util.WebAppConst@WG_ROLE_ID 
		|| #session.scorerInfo.roleId == @com.saiten.util.WebAppConst@ADMIN_ROLE_ID">
		<div class="box">
		<h1 align="left"><s:text name="label.ft.userMenu.note3"></s:text></h1>
		<table class="button_grid">
		<tr>
			<td class="right_side_height_button">
				<s:if test="userMenuIdList.contains(@com.saiten.util.WebAppConst@FORCED_MENU_ID)">
					<a href="scoreSearch.action?selectedMenuId=<s:property value="@com.saiten.util.WebAppConst@FORCED_MENU_ID"/>" id="forcedScoring" class="btn btn-primary btn-xl">
						<%-- <img src="./material/img/button/12_bn-login.gif" width="180" height="39" class="rollover" alt="<s:text name="label.alt.forcedScoring"></s:text>"> --%>
						<s:text name="label.alt.forcedScoring"></s:text>				
					</a>
				</s:if><s:else>
					<%-- <img src="./material/img/button/12_bn-login_on.gif" width="180" height="39" alt="<s:text name="label.alt.forcedScoring"></s:text>"> --%>
			...
			<s:if test="#session.scorerInfo.noDbUpdate != @com.saiten.util.WebAppConst@NO_DB_UPDATE_TRUE">
			    <s:if test="userMenuIdList.contains(@com.saiten.util.WebAppConst@STATE_TRAN_MENU_ID)">
					...
					<%-- <img src="./material/img/button/13_bn-login.gif" width="180" height="39" class="rollover" alt="<s:text name="label.alt.stateTransitionPlanning"></s:text>"> --%>
						<s:text name="label.alt.stateTransitionPlanning"></s:text>
					</a>	
				</s:if><s:else>
					<%-- <img src="./material/img/button/13_bn-login_on.gif" width="180" height="39" alt="<s:text name="label.alt.stateTransitionPlanning"></s:text>"> --%>	
...
<%-- 			<td class="right_side_height_button" >
		...
		<tr>
			...
			<td class="right_side_height_button">
			   <s:if test="userMenuIdList.contains(@com.saiten.util.WebAppConst@DAILY_SCORING_REPORT_MENU_ID)">
			      <a href="dailyScoringReportInit.action" id="dailyScoringReport" class="btn btn-primary btn-xl">
	               <s:text name="menu.btn.dailyScoringReport"/></a>				
				</s:if><s:else>
					<p class="btn btn-disabled"><s:text name="menu.btn.dailyScoringReport" /></p>
				</s:else>
		    </td> 
