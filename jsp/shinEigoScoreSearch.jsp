	...
	<tiles:putAttribute name="body-main">
		    ...
		    <div class="search_box">
					...
					<table class="search_form search_table_width">
									...
									<tr>
										...
										<td class="search_form_class1" >
											<s:textfield id="resultCount" name="scoreInputInfo.resultCount" maxlength="6" size="5" value="%{@com.saiten.util.WebAppConst@TOTAL_RESULT_COUNT_DEFAULT}" />		
										</td>
										</s:if>
									</tr>
									<s:if test="#session.questionInfo.menuId == @com.saiten.util.WebAppConst@SCORE_SAMP_MENU_ID">
		...
		<div id="list_pane">
			<div id="button" align="center" >
				  	<a>
						<s:submit type="button" cssClass="btn btn-primary btn-xl infobutton_without_margin" id="topSearch" cssStyle="width: 144px; height: 39px; margin-bottom:5px; margin-right:5px;" label="%{getText('label.next')}"/>
		  			</a>
