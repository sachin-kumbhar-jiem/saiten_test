...
public class TranAcceptanceDaoImpl extends SaitenHibernateDAOSupport implements TranAcceptanceDao {

	@Override
	public Integer save(TranAcceptance tranAcceptance, String connectionString) {
		try {
			Serializable id = getHibernateTemplate(connectionString).save(tranAcceptance);
	...
	@Override
	public TranAcceptance fetchByAnswerSeqAndUpdatePersonId(Integer answerSeq, String updatePersonId,
		...
		try {
			...
			List<TranAcceptance> list = getHibernateTemplate(connectionString).findByNamedParam(query.toString(),
					paramNames, values);
	...
	@Override
	public List<TranAcceptance> fetchByQuestionNumAndMarkBy(final Integer questionSeq, final String markBy,
