...
public class TranAcceptanceHistoryDaoImpl extends SaitenHibernateDAOSupport
		implements TranAcceptanceHistoryDao {
	...
	public TranAcceptanceHistory fetchByAnswerSeqAndUpdatePersonId(Integer answerSeq,
		...
		try {
			...
			List<TranAcceptanceHistory> list = getHibernateTemplate(
