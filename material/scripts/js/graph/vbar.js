...
html5jp.graph.vbar.prototype.draw = function(items, inparams) {
	...
	var params = {
		...
		xScaleColor: "#000000",
		xScaleFontSize: "10px",
		xScaleFontFamily: "ＭＳ Ｐゴシック",
		yScale: true,
		yScaleColor: "#000000",
		yScaleFontSize: "10px",
		yScaleFontFamily: "ＭＳ Ｐゴシック",
		xCaptionColor: "#000000",
		xCaptionFontSize: "12px",
		xCaptionFontFamily: "ＭＳ Ｐゴシック",
		yCaptionColor: "#000000",
		yCaptionFontSize: "12px",
		yCaptionFontFamily: "ＭＳ Ｐゴシック",
		aLineWidth: 1,
		aLineAlpha: 0.2,
		dLabel: true,
		dLabelColor: "#000000",
		dLabelFontSize: "10px",
		dLabelFontFamily: "ＭＳ Ｐゴシック",
		legend: true,
		legendFontSize: "12px",
		legendFontFamily: "ＭＳ Ｐゴシック",
		legendColor: "#000000"
	};
